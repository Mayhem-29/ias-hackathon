...
def hello_controller():
    return render_template("controller_home.html",
        ...
        add_ctrl_type_api = constants["BASE_URL"] + constants["PORT"]["CTRL_PORT"] + constants["ENDPOINTS"]["CONTROLLER_MANAGER"]["add_controller_type"],
        add_ctrl_instance_api = constants["BASE_URL"] + constants["PORT"]["CTRL_PORT"] + constants["ENDPOINTS"]["CONTROLLER_MANAGER"]["add_controller_instance"],
        sensor_url = constants["BASE_URL"] + constants["PORT"]["SENSOR_PORT"] + constants["ENDPOINTS"]["SENSOR_MANAGER"]["admin"],
    )
